                ...
                >
                    ...
                    */}
                    <ToggleButton
                        ...
                        onClick={() => props.setFilters({ ...props.filters, filterListActive: !props.filters.filterListActive })}
                    >
                    ...
                    */}
                    <>
                        {props.filters.filterListActive && <ToggleButtonGroup
                            value={props.filters.filterButtons}
                            onChange={(event: React.MouseEvent<HTMLElement, MouseEvent>, value: string[]) => props.setFilters({ ...props.filters, filterButtons: value })}
                            aria-label='text formatting'
                            size='small'
                            sx={{ display: 'flex', flexWrap: 'wrap', border: 1, borderRadius: 3 }}
                            color='warning'
                        >
                            <ToggleButton aria-label='Toggle GA 4 filter' title='GA 4' value='analytics4' sx={{ color: 'inherit' }}>
                                <Filter4Icon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Pageview filter' title='Pageview' value='pageview' sx={{ color: 'inherit' }}>
                                <FindInPageIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle App View filter' title='App View' value='appview' sx={{ color: 'inherit' }}>
                                <AppsIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Event filter' title='Event' value='event' sx={{ color: 'inherit' }}>
                                <FlashOnIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Timing filter' title='Timing' value='timing' sx={{ color: 'inherit' }}>
                                <TimelapseIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Social filter' title='Social' value='social' sx={{ color: 'inherit' }}>
                                <ShareIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Item filter' title='Item' value='item' sx={{ color: 'inherit' }}>
                                <ShoppingBasketIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Transaction filter' title='Transaction' value='transaction' sx={{ color: 'inherit' }}>
                                <MonetizationOnIcon fontSize='small' />
                            </ToggleButton>
                            <ToggleButton aria-label='Toggle Exception filter' title='Exception' value='exception' sx={{ borderRadius: 3, color: 'inherit' }}>
                    ...
                    <Stack direction='row' sx={{ display: 'flex', flexWrap: 'wrap', }}>
                        ...
                        */}
                        <ToggleButton
                            ...
                            onClick={() => props.setFilters({ ...props.filters, filterButtons: [], searchedText: '' })}
                        >
                        ...
                        */}
                        <>
                            {props.filters.searchBarActive &&
                                <TextField
                                    id='outlined-search'
                                    label={<Typography fontSize='small' sx={{ color: 'white', }}>Search</Typography>}
                                    type='search'
                                    color='info'
                                    // focused
                                    size='small'
                                    ...
                                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => props.setFilters({ ...props.filters, searchedText: event.target.value })}
                                    sx={{
                    ...
                    */}
                    <FormGroup sx={{ ml: 1 }}>
                        <Stack justifyContent="center" alignItems="center">
                            ...
                            <Switch checked={props.isDarkTheme} color='info' size='small' onChange={(event: React.ChangeEvent<HTMLInputElement>, checked: boolean) => props.setIsDarkTheme(checked)} />
                        </Stack>
                    </FormGroup>
                </Toolbar>
            </Container>
            <Box sx={{ mt: 1, width: '100%', height: 5, background: 'linear-gradient(to right, #C0143C, #FD4239, #007A94, #007A94)' }} />
        </AppBar >
    );
};
